...
if __name__ == "__main__":
    ...
    result = intan_utils.load_rhd_file(file_path)  # Load a specific file by path
    ...
    intan_utils.print_all_channel_names(result)

    # ==== For multi-channel visualization, we can do a waterfall plot ====
    plot_utils.waterfall_plot(emg_data, range(64, 128), t_s, plot_title='Intan EMG data')
    ...
    intan_utils.plot_channel_by_name(ch_name, result)  # By name
    intan_utils.plot_channel_by_index(8, result)  # By index
