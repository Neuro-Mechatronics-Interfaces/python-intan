"""
intan.processing._emg_launcher

Splash screen launcher for the EMGViewer application.

This module creates a centered splash screen displaying the NML logo, waits briefly,
and then transitions into the main EMGViewer GUI. It ensures proper Tkinter initialization
