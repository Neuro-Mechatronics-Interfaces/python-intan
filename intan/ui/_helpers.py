#!/usr/bin/env python3
"""
Shared UI helpers moved from the examples folder into the package.
This keeps example applications lightweight and lets other modules import
shared helpers from `intan.ui`.
"""
import sys
